...
const ProjectCard: FC<ProjectCardProps> = ({
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      case 'Live': return 'bg-green-100 text-green-700 border-green-300/50'
      case 'In Development': return 'bg-yellow-100 text-yellow-700 border-yellow-300/50'
      default: return 'bg-blue-100 text-blue-700 border-blue-300/50'
    }
  }
        ...
        <div className="flex items-start justify-between mb-4">
          <div className="flex-1">
            <div className="flex items-center gap-3 mb-2">
              ...
              <span className={`px-2 py-1 text-xs font-medium rounded-full border shadow-sm ${getStatusColor(status)}`}>
                {status}
              </span>
            </div>
          </div>
          <div className="flex gap-3">
            {github && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-slate-500 hover:text-blue-600 transition-colors duration-200 p-1 rounded-lg hover:bg-blue-50"
            ...
            <div className="grid grid-cols-2 gap-4">
              {metrics.users && (
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <div className="text-sm font-medium text-slate-700">{metrics.users}</div>
              ...
              {metrics.funding && (
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <div className="text-sm font-medium text-slate-700">{metrics.funding}</div>
              ...
              {metrics.timeline && (
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <div className="text-sm font-medium text-slate-700">{metrics.timeline}</div>
              ...
              {metrics.impact && (
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <div className="text-sm font-medium text-slate-700">{metrics.impact}</div>
